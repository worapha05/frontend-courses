  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="harbor-modal-title"
        className={cn(
          'w-full max-w-md rounded-2xl bg-white p-5 shadow-xl ring-1 ring-stone-200 dark:bg-stone-900 dark:ring-stone-700',
          className,
        )}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mb-4 flex items-start justify-between gap-3">
          <h2 id="harbor-modal-title" className="text-lg font-bold">
            {title}
          </h2>
